 ...
 * 重命名load2 js
 */
$(".loadfiletype").on("click",".okfilerename2",function(){
	var checkedfile = $(this).parents(".file-one.file-one-check");
	var loadtype = $(".loadfiletype .box-header .loadfilestype").val();

	var filePath = checkedfile.find(".filePath").val();
	var fileName = checkedfile.find(".fileName").val();
	var fileRename = checkedfile.find(".fileRename").val();

	console.log("filePath" + filePath);
	console.log("fileName" +fileName);
	console.log("fileRename"+fileRename);

	$(".loadfiletype").load("rename2",{filePath:filePath,fileName:fileName,fileRename:fileRename})
});
