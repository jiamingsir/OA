<div class="col-md-12 green" >
	...
	<ul class="nav navbar-nav navbar-right moredeep">
		...
		<li><a href="javascript:changepath('/infromlist');" class="green-none white"><span
				class="glyphicon glyphicon-bell" style="padding-bottom: 15px"></span>
				<#if notice==0>
		...
		<li><a href="javascript:changepath('/mail');" class="green-none white"><span
				class="glyphicon glyphicon-envelope" style="padding-bottom: 15px"></span>
				<#if mail==0>
		...
		<li><a href="javascript:changepath('/mytask');" class="green-none white"><span
				class="glyphicon glyphicon-flag" style="padding-bottom: 15px"></span>
				<#if task==0>
		...
		<a href="#" class="green-none white" data-toggle="dropdown">
				<img src="/image/${(user.imgPath)!'/timg.jpg'}" class="user-image" /> <span>${user.realName}</span>
		</a> <!--设置点击按钮弹出用户面板层-->
			<ul class="dropdown-menu" style="padding:0;">
				...
				<li class="user-footer">
					...
					<div class="pull-left">
						<a href="javascript:changepath('changepwd');" class="btn btn-default">修改密码</a>
					</div>
