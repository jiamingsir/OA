<div class="bgc-w box box-primary">
	...
	<div class="box-header">
		...
		在职：<input type="radio" name="isOnJob" value="0" class="isOnJob" />
		离职：<input type="radio" name="isOnJob" value="1" class="isOnJob" />
		<div class="box-tools">
			<div class="input-group" style="width: 150px;">
				<input type="text" class="form-control input-sm usersearch"
					placeholder="查找..." value="${(usersearch)!''}"/>
			...
			<table class="table table-hover table-striped">
				...
				<#list users as user>
					<tr>
						...
						<td><a  href="userroleedit?userid=${user.userId}" class="label xiugai"><span
...
<script>
	$("input:radio[value=${isOnJob}]").attr('checked',true);//让单选框根据比对的值而自动勾选
