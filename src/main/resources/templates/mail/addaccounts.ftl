				...
				<!--錯誤信息提示  -->
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
                          ...
                          <#--  value="${username}"  value ="${(mails.mailUserId.realName)!''}" -->
                            <#--<td  colspan="6">-->
								<#--<input type="text" class="form-control inpu" id="account_Name" name="accountName"/>
                                <div class="reciver">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control mail" name="mailAccount" value="${(mails.mailAccount)!''}" readonly="readonly"/>
                            </div>
						<div class="col-md-6 form-group">
						...
						<div class="col-md-6 form-group">
							...
							<input class="form-control " type="text" value="${(mails.mailDes)!''}" name="mailDes" />
                            <input class="" name="password" value="${(mails.password)!''}" style="display:none;"/>
