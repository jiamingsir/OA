...
<div class="col-md-12 see" style="height: 100%">
		...
		<div class="row">
			<div class="box-body">
				<div class=" mailbox-read-info">
					...
					<h5 class="fonts">
						<span id="ctl00_cphMain_lblFrom" class="mailbox-read-time">发送：<i>${pushdept}</i>&nbsp;- &nbsp;<i>${pushname}</i>
				...
				<div class="mailbox-read-message" style="height: 500px">
					...
					<span id="ctl00_cphMain_lblFeedback"style="height: 490px">
						<div  style="padding-left: 64px;height: 450px;width:1000px;overflow:scroll"><#--class="pre-scrollable" height: 450px;width:1000px;overflow-y:auto-->
							<p>${mail.content}</p>
						</div>
					</span>
