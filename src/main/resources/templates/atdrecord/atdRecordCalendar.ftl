...
<div class="row" style="padding-top: 10px;">
	<div class="col-md-2">
		<h1 style="font-size: 24px; margin: 0;" class="">打卡日历图</h1>
	</div>
	<div class="col-md-10 text-right">
		<a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a
			disabled="disabled">打卡日历图</a>
	</div>
</div>
							...
							<div class="box-body">
								<div style="border-bottom: 1px solid #f4f4f4;">
									...
									<h5 style="color: #999;font-size: 13px;">
										<span>日期：<span class="atdDate"></span>   时间：<span class="atdTime"></span></span>
										迟到？ <span class="atdState">2017-10-20 21:44</span></span>
									</h5>
								</div>
...
<script>
	...
	/*		eventClick: function(event) {
				...
				var recDate = event.recDate;
				var endtime = event.recDate;
				var endtime = event.recTime;
				console.log(typeid); 
				var typename;
				if(typeid=='44'){
					typename='日程提醒';
				...
				$.ajax({
					 ...
					 success:function(data){
						 ...
						 $.each(data,function(i,item){
							 ...
							 if('09:00' >= item.rectime || item.rectime >= '17:00'){
								 color="#00c0ef";
							 }
							 if(item.rectime >'09:00' && item.rectime < '17:00'){
								 color="#f0ad4e";
							 }
							 if(item.rectime >'09:30' && item.rectime < '16:30'){
								 color="#dd4b39";
							 }
