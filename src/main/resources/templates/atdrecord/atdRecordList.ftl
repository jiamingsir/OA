...
<head>
	...
	<script type="text/javascript" src="js/atdrecord/monthtable.js"></script>
</head>
<body>
<div class="row" style="padding-top: 10px">
	<div class="col-md-2">
		<h1 style="font-size: 24px; margin: 0;" class="">打卡记录</h1>
	</div>
	<div class="col-md-10 text-right">
		<a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> >
		<a disabled="disabled">打卡记录</a>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="box-header ">
				...
				<div class="box-body">
					<div id="ss" class="thistable">
						<#include "/atdrecord/atdRecordListtbale.ftl">
					</div>
				</div>
			</div>
		</div>
