...
<body style="background-color: #ecf0f5;">
	<div class="row" style="padding-top: 10px;">
		<div class="col-md-2">
			<h1 style="font-size: 24px; margin: 0;" class="">文件中心</h1>
		</div>
		<div class="col-md-10 text-right">
			<a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> >
			<a disabled="disabled">文件中心</a>
		</div>
	</div>
	<div class="row" style="padding-top: 15px;">
		<#--<div class="col-md-3">
			<form class = "fileuploadform" action="smbPut" method="post" enctype="multipart/form-data">
			<!-- <a class="btn btn-primary" href="##"
				style="width: 100%; margin-bottom: 20px;"><span
				class="glyphicon glyphicon-open"></span> 上传</a> &ndash;&gt;
		...
		<div class="col-md-9">
			...
			<div class="loadfiletype">
				<#include "/file/filetypeload2.ftl"/>
			</div>
		</div>
	</div>
					...
					<div class="box-body no-padding">
						...
						<ul class="nav nav-pills nav-stacked mm" style="padding-left:15px;">
							<#--<#list mcpaths as path>
								&lt;#&ndash;<div class="pathidcompare" pathId="${path.id}">&ndash;&gt;
									<div class="box-header no-padding">
										...
										<span class="openpath modalajax">
											<div class="mcflooropen"></div>
											&lt;#&ndash;<h3 class="box-title" style="font-size:12px;">${path.pathName}</h3>&ndash;&gt;
											&lt;#&ndash;<input class="mctopathid" type="hidden" value="${path.id}" />&ndash;&gt;
										</span>
									</div>
