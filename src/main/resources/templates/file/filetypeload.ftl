...
<div class="bgc-w box box-primary" style="height: 855px;">
	<!--盒子头-->
	...
	<div class="box-body no-padding">
		...
		<div style="padding: 5px;">
			...
			<div class="btn-group">
				...
				<#else>
					<a onclick="{return confirm('文件将放入回收站，确定删除吗？');};"  class="btn btn-sm btn-default topdelete" href="deletefile?pathid=${nowpath.id}&ch5eckpathids=&checkfileids=" title="删除">
						<span class="iconfont icon-lajitong"></span>
					</a>
