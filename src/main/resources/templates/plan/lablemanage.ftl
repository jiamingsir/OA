...
.bgc-w {
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box box-primary" style="height: 100%">
				<!--盒子头-->
				<div class="box-header">
					<h3 class="box-title">
						<a href="lableedit" class="label label-success" style="padding: 5px;">
...
<script>
	$('.baseKeySubmit').on('click',function(){
		...
		$('.thistable').load("labletable?name="+name);
	});
</script>