			...
			<div class="box-body">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input class="form-control shijian" id="starTime" name="startTime" value="<#if plan??>${plan.startTime}</#if>"/>
					</div>
					<div class="col-md-6 form-group">
						<label class="control-label">结束时间</label>
						<input class="form-control shijian" id="endTime" name="endTime" value="<#if plan??>${plan.endTime}</#if>"/>
					</div>
				</div>
