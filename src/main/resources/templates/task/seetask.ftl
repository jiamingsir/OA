			...
			<form action="tasklogger">
				<div class="row">
					<div class="box-body"
						...
						<div class=" mailbox-read-info">
							...
							<#--<#if task.reciverlist??>-->
								<h5 class="fonts">
									...
									<span id="ctl00_cphMain_lblFrom" class="mailbox-read-time">发布人：<i>${user.dept.deptName}</i>&nbsp;-&nbsp; <i>${user.realName}</i> &nbsp;&nbsp;协助：<i>${(task.linker)!''}</i></span>
						...
						<div class="mailbox-read-message">
							...
							<span id="ctl00_cphMain_lblFeedback">
								<h5 style="margin-top: 20px;">
									任务时间（${task.starTime}至 ${task.endTime}） <small
						...
						<#--<div class="col-md-6 form-group">
							<label> <span id="ctl00_cphMain_Label2">连接</span>
							</label><input name="fileFile" type="text"
                                           id="ctl00_cphMain_txtPowerValue" class="form-control" value="${(task.fileFile)!''}"/>
						&lt;#&ndash; <input name="loggerTicking" type="text"
								id="ctl00_cphMain_txtPowerValue" class="form-control" />&ndash;&gt;
                        ...
                        <div  style="display: none"><input type="text"  id ="per" class="form-control input" value="${(fileFiles)!""}" readonly="readonly"  name="fileFile"/></div>
                        <div  style="display: none"><input type="text"  id ="per2" class="form-control input" value="${(fileNames)!""}" readonly="readonly"  name="fileName"/></div>
					</div>
	...
	<script >
        ...
        $(function(){
            ...
            if (hrefs!=''||hrefs!=null) {
               ...
               // $('#body').load("byidsgeturl",{datebegin:datebegin,dateend:dateend,processSelect:processSelect,sender:sender/*,deptSelect:deptSelect*/});



                /*var a1 = '<kbd><a  href="downfilecom?Src=';*/
                var a1 = '<kbd><a  href="taskdownfiles?Src=';
