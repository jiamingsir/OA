...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<!--盒子身体-->
			<form action="addtasks" method="post" enctype="multipart/form-data" onsubmit="return check();">  <#--//ck_addtask-->
				...
				<div class="box-body">
					...
					<div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="number" value="<#if number??>${number}</#if>" readonly="readonly"/>
                        </div>
                        <div class="col-md-6 form-group">
						...
						<div class="col-md-6 form-group">
                            ...
                            <select class="form-control" name="typeId">
						    <#list lablelist as l>
                                <option value="${l.id}" >${l.workLabel}</option>
							</#list>
                            </select>
						</div>
						<div class="col-md-6 form-group">
						...
						<div class="col-md-6 form-group">
							...
							<input class="form-control shijian" id="starTime" name="starTime"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label">结束日期</label>
							<input  class="form-control shijian" id="endTime" name="endTime"/>
						</div>
						<div class="col-md-6 form-group">

							<label class="control-label">相关项目</label> <input name="linkobj"
								type="text" id="linkobj" class="form-control" />
						</div>
                        <div class="col-md-6 form-group">

                            <label class="control-label">协助部门</label> <input name="linker"
                                                                             type="text" id="linker" class="form-control" />
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea class="form-control tent" name="taskDescribe" style="width: 100%; height: 300px; visibility: hidden; font-size: 20px;"></textarea>
						...
						<#--<div class="col-md-6 form-group">
							...
							<input class="form-control " name="fileFile"></input>
						</div>-->
                        <#--<div class="form-group">
                            <input name="inReceiver" type="text"
                                   id="recive_list" style="background-color: #fff;"
                                   class="form-control" readonly="readonly" placeholder="文件：" />
                            <div class="reciver">
				        <span class="label label-success glyphicon glyphicon-plus"
                            data-toggle="modal" data-target="#myModal">文件选择</span>
                            </div>
                        </div>-->
