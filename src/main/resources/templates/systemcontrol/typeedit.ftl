				...
				<div class="alert alert-danger alert-dismissable" role="alert"
					...
					<div class="row">
						<div class="col-md-6 form-group">
                            ...
                            <select class="form-control" name="typeModel">
								 <#if typeObj??>
								 	<option value="${typeObj.typeModel}" selected="selected">${typeObj.typeModel}</option>
								 </#if>
								 <#list parentList as list>
									 <#if typeObj?? && list.typeId == typeObj.typeId>
								      <option value="${list.typeModel}" selected="selected">${list.typeModel}</option>
									 <#else>
									 <option value="${list.typeModel}">${list.typeModel}</option>
									 </#if>
