			...
			<div class="box-body no-padding">
				<div class="box-body">
						...
						<div class="col-md-6 form-group">
                            ...
                            <select class="form-control" name="statusModel">
								 <#if status??>
								 	<option value="${status.statusModel}" selected="selected">${status.statusModel}</option>
								 </#if>
								 <#list parentList as list>
									 <#if status?? && list.statusId == status.statusId>
								      <option value="${list.statusModel}" selected="selected">${list.statusModel}</option>
									 <#else>
									 <option value="${list.statusModel}">${list.statusModel}</option>
									 </#if>
