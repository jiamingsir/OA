...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="saveExit"  enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
                    <td class="title"><label class="control-label">离职人员</label></td>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="senderName" value="${username}" readonly="readonly"/></td>
                    ...
                    <tr >
                        <td class="title"><label class="control-label">部门</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="dept" value="${dept}" readonly="readonly"/></td>
