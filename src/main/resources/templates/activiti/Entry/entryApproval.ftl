...
<div class="row" style="padding-top: 10px;">
    <div class="col-md-2">
        <h1 style="font-size: 24px; margin: 0;" class="">入职流程</h1>
    </div>
    <div class="col-md-10 text-right">
        <a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a
            disabled="disabled">入职流程</a>
    </div>
</div>
<div class="row" style="padding-top: 15px;">
    <div class="col-md-12">
        ...
        <div class="bgc-w box">
            ...
            <form action="saveEntry" enctype="multipart/form-data" method="post" name="rrrr" onsubmit="return check();" >
                <div class="box-header">
                    ...
                    <table class="bo table ">
                        ...
                        <tr >
                            <td colspan="14" class="title"><h2>入职单</h2></td>
                        ...
                        <tr >
                            ...
                            <td  colspan="6"><input type="text" class="form-control input"
                                                    readonly="readonly" value="${(entry.processname)!""}" name="processname"/></td>


                            <td class="title" ><label class="control-label">编号</label><span style="color:red">*</span></td>
                            <td  colspan="6"><input type="text" readonly="readonly" class="form-control inpu" value="${(entry.number)!""}" name="number"/></td>
                        ...
                        <tr >
                            <td class="title" ><label class="control-label">应聘人</label><span style="color:red">*</span></td>
                            <td  colspan="6"><input type="text" class="form-control input" value="${(entry.empName)!""}" readonly="readonly"  name="empName"/></td>

                            <td class="title" ><label class="control-label">联系方式</label></td>
                            <td  colspan="6"><input type="text" class="form-control input" value="${(entry.phone)!""}"  name="phone" readonly="readonly"/></td>
                        </tr>
                        <tr >

                            <td class="title" ><label class="control-label">应聘部门</label><span style="color:red">*</span></td>
                            <td  colspan="6"><input type="text" class="form-control input" readonly="readonly"  name="secondParty" value="${(entry.dept)!""}"/></td>

                            <td class="title" ><label class="control-label">应聘职位</label><span style="color:red">*</span></td>
                            <td  colspan="6"><input type="text" class="form-control input" readonly="readonly"  name="position" value="${(entry.position)!""}"/></td>
                        </tr>

                        <tr >

                            <td class="title" ><label class="control-label">入职时间</label></td>
                            <td  colspan="6"><input type="text" class="form-control input" value="${(entry.joinDate)!""}"  name="joinDate" readonly="readonly"/></td>

                            <td class="title"><label class="control-label">备注</label></td>
                            <td  colspan="6"><input type="text" class="form-control inpu" value="${(entry.remark)!""}" readonly="readonly" name="remark"/></td>
                        </tr>
                        <tr >
                            ...
                            <td  colspan="6" style="display: none"><input type="text"  id ="per" class="form-control input" value="${(entry.fileFile)!""}" readonly="readonly"  name="fileFile"/></td>
                        </tr>
