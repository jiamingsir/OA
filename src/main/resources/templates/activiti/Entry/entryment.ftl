...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="saveEntry"  enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
                    <td class="title"><label class="control-label">应聘人</label></td>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="empName"/></td>
                    ...
                    <tr >
                        <td class="title"><label class="control-label">应聘部门</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="dept"/></td>


                        <td class="title"><label class="control-label">应聘职位</label></td>
