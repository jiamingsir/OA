...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="saveContractxq"  enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<#--<tr >
					...
					<tr>
                        ...
                        <td  colspan="6">
							<#--<input type="text" class="form-control inpu" name="jieshou"/>-->
                            <select class="form-control inpu" name="types">
                                <option value="中心or部门">中心or部门</option>
