...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="saveRegular"  enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
					...
					<td  colspan="14"><input type="text" class="form-control inpu" name="processname"/></td>
                    <#--<td class="title" ><label class="control-label">编号</label></td>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="number"/></td>-->
				...
				<#--<tr >
                    ...
                    <td  colspan="6"><input type="text" class="form-control inpu"
						name="deptsend" value="${dept}" readonly="readonly"/></td>
				</tr>-->
				
				<tr >
                    <td class="title"><label class="control-label">姓名</label></td>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="empName" />
                        <div class="reciver">
                    ...
                    <td  colspan="6"><input type="text" class="form-control inpu" name="joinDate" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})"/></td>
				</tr>
                    <tr >
                        <td class="title"><label class="control-label">中心/部门</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="dept"/></td>


                        <td class="title"><label class="control-label">职位</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="position"/></td>
                    </tr>
                    <tr >
                        <td class="title"><label class="control-label">考评期限</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu " name="beginDate" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})"/></td>

                        <td class="title"><label class="control-label">至</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="endDate" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})"/></td>
                    </tr>
                    <tr >
                        <td class="title"><label class="control-label">直接上级</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="supemp"/>
                            <div class="reciver">
								<span class="label label-success glyphicon glyphicon-plus"
								>通讯录</span>
                            </div>
                        ...
                        <td class="title"><label class="control-label">职位</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="supempPosition"/></td>
                    </tr>
                    <tr >
                        <td class="title"><label class="control-label">中心/部门负责人</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="depter"/>
                            <div class="reciver">
								<span class="label label-success glyphicon glyphicon-plus"
                                >通讯录</span>
                            </div>
                        ...
                        <td class="title"><label class="control-label">职位</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="depterPosition"/></td>
                    </tr>
                    <tr >

                        <td class="title"><label class="control-label">备注</label></td>
                        <td  colspan="14"><input type="text" class="form-control inpu" name="remark"/></td>
                    </tr>
				<tr >
                    ...
                    <td  colspan="6">
                        <div class="btn btn-default"style="position: relative; overflow: hidden;width: 100%;margin-top: -6px;">
                            <i class="glyphicon glyphicon-open"></i> 上传评估表
