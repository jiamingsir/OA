...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="expense"  enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
					...
					<td  colspan="6"><input type="text" class="form-control inpu" name="feeName"/></td>
				...
				<tr >
                    <td class="title" ><label class="control-label">提单人员</label><span style="color:red">*</span></td>
				...
				<tr >
                    ...
                    <td  colspan="6"><input type="text" class="form-control inpu" name="feeContent"/></td>
                    ...
                    <td  colspan="6"><input type="text" class="form-control inpu" name="feeFee"/></td>
				</tr>
				<tr >
                    <td class="title" ><label class="control-label">支付方式</label><span style="color:red">*</span></td>
                    <td colspan="6">
                        <select class="form-control inpu" name="feePaytype">
					<#list uplist as list>
				...
				<#--<td class="title" ><label class="control-label">审核人员</label></td>
                    ...
                    <#--<td class="title" ><label class="control-label">费用日期</label></td>
                    <td  colspan="6"><input type="text" class="form-control inpu holistart"  name="feeDate"/></td>-->
                    <td class="title" ><label class="control-label">相关票据</label><span style="color:red">*</span></td>
                    <td  colspan="3">
                    ...
                    <td  colspan="3">
                        <div class="btn btn-default"style="position: relative; overflow: hidden;width: 100%;margin-top: -6px;">
                            <span class="labels"><label><input name="fileRadios" type="checkbox" value="选中"><i>✓</i></label>发票候补</span>
                            <#--<input type="radio" name="fileRadio"   id="filesxuan" value="选中"><span>发票候补</span></input>-->
                        </div>
                    </td>
				</tr>
				...
				<tr >
                    ...
                    <tr >
                        ...
                        <td  colspan="6"><input type="text" class="form-control inpu" name="contractPaynew"/></td>
                        <td class="title"><label class="control-label">累计已支付金额</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="contractPaysum"/></td>
                    </tr>
					<#--<hr style="height: 1px;background-color: #00a4d6"></hr>-->
                    <#--<tr>
                        <td class="title"><label class="control-label">票据</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" id="feefiles" name="feeFile"/></td>
				...
				<tr >
					...
					<td colspan="14" style="text-align: right;" >
                        <input   type="text" value="费用报销" id="rad" name="fileRadio" hidden="hidden"/>
...
function check() {
	console.log("开始进入了");
    var s='';
    $('input[name="fileRadios"]:checked').each(function(){
        s+=$(this).val();
    });
    $('#rad').val(s);
