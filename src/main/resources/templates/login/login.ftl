...
/* 
	...
	.modal-dialog {
		...
		/*body{background:url(images/oabackground-min.jpg) top left  no-repeat;
			background-size:90% ;
			position:absolute;}*/
...
<body>
<div style="background:url(images/oabackground-min.jpg) top left  no-repeat;background-size:90% ;position:absolute; ">
  <div class="cont_centrar" style="top:5%;">
	 <div class="cont_login" style="margin:270px 1150px 0 330px">
      <div class="cont_forms cont_forms_active_login" style="height: 480px;width: 400px;border-radius: 15px;">
        ...
        <div class="cont_form_login" style="display: block;opacity: 1;width: 400px;">
          ...
          <#-- <div class="login-img" style="display:inline-block">
		    ...
		    <br>
       <button class="btn_login btn" type="submit" style="background-color: #ff7b1d" >LOGIN</button>
