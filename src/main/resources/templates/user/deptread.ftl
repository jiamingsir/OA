							...
							<div class="row">
								...
								<#if deptmanage??>
									...
									<div class="col-md-6">
										...
										<select class="deptselect form-control" name="changedeptid">
											<#list depts as d>
												<#if d.deptName == dept.deptName >
													<option selected="selected" value="${d.deptId}"} >${d.deptName}</option>
												<#else >
													<option value="${d.deptId}"}>${d.deptName}</option>
												</#if>
											</#list>
									...
									<div class="col-md-6">
										...
										<select class="positionselect form-control" name="positionid">
											<#list positions as position>
												<#if position.id == deptManager.position.id>
									...
									<div class="col-md-6">
										<#if deptuser?? & deptuser?size gt 0>
											...
											<select class="form-control" name="newmanageid">
												<#list deptuser as user>
													<#if user.userId == deptManager.userId>
