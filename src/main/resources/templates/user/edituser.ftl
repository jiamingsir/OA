				...
				<div class="box-body no-padding">
					<div class="box-body">
						...
						<div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>英文名</span></label> <input
                                    name="pinyin" class="form-control" value="${(user.pinyin)!''}"/>
                            </div>
						<#--	<div class="col-md-6 form-group">
						...
						<#--	<div class="col-md-6 form-group">
							...
							<#--<#if user??>
                                <option value="${(user.role.roleId)!''}">${user.role.roleName}</option>
									...
									<#list roles as role>
										<#if user?? && role.roleId == user.role.roleId>
							...
							<div class="col-md-6 form-group">
								...
								<select class="deptselect form-control" name="deptid" id="deptid">
									<#--<#if user??>
										<option value="${(user.dept.deptId)!''}">${user.dept.deptName}</option>
									</#if>-->
									<#list depts as dept>
										<#if user?? && user.dept.deptId == dept.deptId>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="positionselect form-control" name="positionid">
									...
									<#list positions as position>
										<#if user?? && user.position.id == position.id>
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>胸牌卡号</span></label> <input
                                    name="cardId" class="form-control" value="${(user.cardId)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>分机号</span></label> <input
                                    name="fenji" class="form-control" value="${(user.fenji)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>直机号</span></label> <input
                                    name="zhixian" class="form-control" value="${(user.zhixian)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
						...
						<#--<#if where??>-->
							<div class="row">
								...
								<div class="col-md-6 form-group">
									<label class="control-label"> <span>是否在职</span>
									</label> <select class="form-control" name="isLock" value="${(user.isLock)!''}" id="isLock">
...
function check() {
	...
	$('.form-control').each(function(index) {
		...
		if ($(this).val() == "") {
			// 排除哪些字段是可以为空的，在这里排除
			if (index == 3 || index == 10 || index == 11 || index == 12 || index == 13 || index == 15) {
				return true;
			}
