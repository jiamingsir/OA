	...
	<div class="col-md-9" style="margin-bottom: 60px;">
		...
		<div class=" nav-tabs-custom">
			...
			<#--	<li class="mynote active"><a href="#memo" data-toggle="tab">我的便签</a></li>
				...
				<li class="mynote active"><a href="#memo" data-toggle="tab">个人设置</a></li>
			</ul>
				...
				<div class="active tab-pane thistable" id="memo">
					...
					<div class="alert alert-danger alert-dismissable" style="display:none;" role="alert">
						...
						<div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span id="ctl00_cphMain_Label3">真实姓名</span></label> <input
                                    name="realName" type="text" value="${user.realName}" readonly="readonly"
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>邮箱密码</span></label> <input
                                    name="emailpwd" type="password" value="${(user.emailpwd)!''}" autocomplete="new-password"
						...
						<#--	<div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								<label class="control-label"><span id="ctl00_cphMain_Label13">邮箱昵称</span></label> <input
									name="userSign" type="text" value="${(user.userSign)!''}"
									id="ctl00_cphMain_txtNote" class="form-control" />
							</div>

							<div class="col-md-6 form-group">
								<label class="control-label"><span>PCMAC密码</span></label> <input
										name="pcmacpwd" type="password" value="${(user.pcmacpwd)!''}" autocomplete="new-password"
 	...
 	$('#settings .form-control').each(function(index) {
 		...
 		if ($(this).val() == "") {
 			...
 			if (index == 2) {
 				...
 				if($savepassword != '' || $savepassword != undefined || $newpassword != '' || $newpassword != undefined){
