...
//	@NotEmpty(message="卡号不能为空")
	...
	@Column(name="upfather_id")
	private Long upfatherId;		//上司id
	...
	@Column(name="pcmacpwd")
	private String pcmacpwd;		//PCMAC 密码

	@Column(name="emailpwd")
	private String emailpwd;		//email 密码

	@Column(name="fenji")
	private String fenji;		//电话分机

	@Column(name="zhixian")
	private String zhixian;		//电话直线
...
public void setSuperman(Boolean superman) {
	...
	public Long getUpfatherId() {
		return upfatherId;
	}

	public void setUpfatherId(Long upfatherId) {
	...
	public String getPcmacpwd() {
		return pcmacpwd;
	}

	public void setPcmacpwd(String pcmacpwd) {
		this.pcmacpwd = pcmacpwd;
	}
	...
	public String getZhixian() {
		return zhixian;
	}

	public void setZhixian(String zhixian) {
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userTel=" + userTel + ", realName=" + realName
				...
				+ ", fatherId=" + fatherId + ", upfatherId=" + upfatherId + ", holiday=" + holiday + ",superman=" + superman + ",pinyin=" + pinyin + "]";
	}*/
