...
public class Tasklist implements Serializable {
	...
	public Tasklist(Long typeId, Date publishTime, Date starTime, Date endTime, Date modifyTime, String title, String reciverlist, User usersId, String taskDescribe, String comment, Boolean top, Boolean cancel, String ticking, Integer statusId, String number, String linkobj, String linker, String fileFile) {
		this.typeId = typeId;
		this.publishTime = publishTime;
		this.starTime = starTime;
		this.endTime = endTime;
