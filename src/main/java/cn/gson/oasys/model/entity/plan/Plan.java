...
public class Plan {
	...
	public Plan(Long typeId, Long statusId, String attachId, Date startTime, Date endTime, Date createTime, String title,
			String label, String planContent, String planSummary, String planComment, User user,Long lableid) {
		super();
		this.typeId = typeId;
