...
public class Pagemail {
	...
	private String mailFileids;//邮件（可以是多个）
	...
	public Pagemail(Long mailId, Long mailType, Long mailStatusid, String mailTitle,String inReceiver,
			Long mailFileid, String mailFileids, Date mailCreateTime, Boolean star, Boolean read) {
		super();
		this.mailId = mailId;
	...
	public String getMailFileids() {
		return mailFileids;
	}

	public void setMailFileids(String mailFileids) {
		this.mailFileids = mailFileids;
	}
