...
@Query("select mn from Mailnumber  mn where mn.mailUserId =?1 ")
	List<Mailnumber> findByUserIds(User userbyid);
	@Query("select u from Mailnumber u where u.mailUserId=?1")
	List<Mailnumber> findByid(User useid);
