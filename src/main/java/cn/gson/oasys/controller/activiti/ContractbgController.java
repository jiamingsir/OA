...
@Controller
@RequestMapping("/")
public class ContractbgController {

    @Autowired
    private UserDao userDao;

    @Autowired
    private ContractbgDao contractbgDao;
    ...
    public String leave(Model model, @SessionAttribute("userId") Long userId, HttpServletRequest request,
        ...
        return "activiti/Contractbg/contractbgment";
    }
     ...
     */
    @RequestMapping("saveContractbg")
    public String contractbg(HttpSession session , HttpServletRequest req, @RequestParam("filePath")MultipartFile[] filePath,
                             @RequestParam(value = "option",defaultValue="") String option ,
                             @RequestParam(value = "processInstanceId",defaultValue="") String processInstanceId ,
                             @Valid Contractbg bu, BindingResult br,
...
//是否推送邮件
     ...
     *
     * */
    private void setVariables(HttpSession session , Map<String, Object> variables, String processname,Contractbg eve){
