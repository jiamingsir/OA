...
public class EntryController {
    ...
    public String entry(Model model, @SessionAttribute("userId") Long userId, HttpServletRequest request,
        ...
        return "activiti/Entry/entryment";
    }
    ...
    public String saveentry(HttpSession session , HttpServletRequest req, @RequestParam("filePath")MultipartFile[] filePath,
                            @RequestParam(value = "option",defaultValue="") String option ,
                            @RequestParam(value = "processInstanceId",defaultValue="") String processInstanceId ,
                            @Valid Entry bu, BindingResult br,
...
//是否推送邮件
     ...
     *
     * */
    private void setVariables(HttpSession session , Map<String, Object> variables, String processname,Entry eve){
        ...
        //String deptFatherName = user.getDept().getDeptFatherId().getDeptFatherName();
            ...
            if(processname.equals("入职流程")) {
                ...
                String mianshi = userDao.findUsersByRoleName("面试官").get(0).getRealName();
                ...
                variables.put("mianshier", mianshi);
