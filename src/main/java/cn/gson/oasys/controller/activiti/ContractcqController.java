...
import cn.gson.oasys.model.dao.activitidao.ContractcqDao;
...
@Controller
@RequestMapping("/")
public class ContractcqController {
    ...
    @Autowired
    private ContractcqDao contractcqDao;
    ...
    public String leave(Model model, @SessionAttribute("userId") Long userId, HttpServletRequest request,
        ...
        return "activiti/Contractcq/contractcqment";
    }
     ...
     */
    @RequestMapping("saveContractcq")
    public String contractcq(HttpSession session , HttpServletRequest req, @RequestParam("filePath")MultipartFile[] filePath,
                             @RequestParam(value = "option",defaultValue="") String option ,
                             @RequestParam(value = "processInstanceId",defaultValue="") String processInstanceId ,
                          @Valid Contractcq bu, BindingResult br,
...
//是否推送邮件
     ...
     *
     * */
    private void setVariables(HttpSession session , Map<String, Object> variables, String processname,Contractcq eve){
        ...
        int feeflag =0;
        /*if (fee.compareTo(fee1.ZERO) >= 0){
            feeflag = 1;
        }*/
            if(processname.equals("合同初签")) {
