...
public class LoginsController {
	...
	public static String pcmancUsername;
	public static String pcmacPassword;
	...
	public String loginCheck(HttpSession session,HttpServletRequest req,Model model) throws UnknownHostException{
		...
		if(sessionId==user.getUserId()){
			...
			pcmancUsername = user.getUserName();
			if(user.getPcmacpwd() != null) {
				pcmacPassword = user.getPcmacpwd();
			}else {
				pcmacPassword = "";
			}
