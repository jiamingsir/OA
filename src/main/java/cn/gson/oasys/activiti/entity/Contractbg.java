...
@Entity
@Table(name = "process_contractbg", schema = "xyoa")
public class Contractbg {
    ...
    public int hashCode() {
        ...
        return Objects.hash(processname, senderId, senderName, newDate, dept, contractNumber, firstParty, secondParty, phone, beginDate, endDate, remark, processid, fileFile, type, secondphone, orContractid, id);
    }
}
