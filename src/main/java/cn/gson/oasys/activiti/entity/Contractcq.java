...
@Entity
@Table(name = "process_contractcq", schema = "xyoa", catalog = "")
public class Contractcq {
    private long id;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, processname, senderId, senderName, newDate, dept, contractNumber, firstParty, secondParty, phone, beginDate, endDate, remark, processid, fileFile, type, secondphone);
    }
}
